...
class MyAnim : View {
    ...
    constructor(c:Context , a:AttributeSet) : super(c,a) {
        ...
        thirdColor = t!!.getColor(R.styleable.MyAnim_secondColor,c.resources.getColor(android.R.color.holo_blue_dark))
        fourthColor = t!!.getColor(R.styleable.MyAnim_thirdColor,c.resources.getColor(android.R.color.holo_orange_dark))
